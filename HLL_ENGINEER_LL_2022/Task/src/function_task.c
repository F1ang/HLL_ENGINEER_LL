		...
		else if(function_robot_mode->control_device == 2)
		{
			...
			//翻转  S1-3 to 1 ，与夹取关联
			  ...
			  //救援
				...
				{	
						LL_TIM_OC_SetCompareCH3(TIM3 ,500);//PB0_PWM_OUT(0)  救援左     
	          LL_TIM_OC_SetCompareCH4(TIM3 ,1000);//PB1_PWM_OUT(0)  救援右    
				}
				else
				{
						LL_TIM_OC_SetCompareCH3(TIM3 ,1200);//PB0_PWM_OUT(0)  救援左     
	          LL_TIM_OC_SetCompareCH4(TIM3 ,500);//PB1_PWM_OUT(0)  救援右     
				}
		}//remote_end
