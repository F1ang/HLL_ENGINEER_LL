...
static Pid_Position_t motor550_r_speed_pid = NEW_POSITION_PID(0.7, 0.2, 0.1, 20, 400, 0, 50, 100); 
static Pid_Position_t motor550_r_angle_pid = NEW_POSITION_PID(0.03, 0, 0, 150, 450, 0, 50, 100);  


static Pid_Position_t motor550_s_speed_pid = NEW_POSITION_PID(0.7, 0.2, 0.1, 20, 400, 0, 50, 100); 
static Pid_Position_t motor550_s_angle_pid = NEW_POSITION_PID(0.03, 0, 0, 150, 450, 0, 50, 100); 
...
void Set_550_Motors_Speed(float speed_550_l,float speed_550_r,float speed_550_s)
{
	...
	Pid_Position_Calc(&motor550_s_speed_pid, speed_550_s, motor550_r.speed_rpm);
